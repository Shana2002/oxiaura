    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative text-center py-16 md:py-24 bg-cover bg-center h-[60vh] flex items-center justify-center " style={{ backgroundImage: "url('/placeholder-leaves.png')" }}>
        ...
        <div className="relative z-10 px-4">
          <p className="text-lg md:text-7xl text-gray-700 mb-2">From Plantation to You</p>
          <h1 className="text-3xl md:text-8xl font-bold text-green-700 leading-tight">
            Pure, Authentic, Responsible
          </h1>
          {/* Green leaf elements as decorations - you'd use actual image assets here */}
          <div className="absolute top-4 left-4">
            <Image src="/images/placeholder-leaf.png" alt="Leaf" width={30} height={30} />
          </div>
          <div className="absolute top-10 right-8">
            <Image src="/images/placeholder-leaf.png" alt="Leaf" width={40} height={40} />
          </div>
          <div className="absolute bottom-4 left-1/4">
            <Image src="/images/placeholder-leaf.png" alt="Leaf" width={25} height={25} />
          </div>
          <div className="absolute bottom-8 right-1/4">
            <Image src="/images/placeholder-leaf.png" alt="Leaf" width={35} height={35} />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto px-4 py-12 ">
        <div className="flex items-center justify-center gap-8">
          <div className="relative rounded-lg overflow-hidden shadow-lg h-[60vh] w-1/4">
            <Image
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg h-[70vh] w-1/3">
            <Image
