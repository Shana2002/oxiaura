...
<div className="h-screen flex flex-col w-full items-center justify-center px-4 md:px-0">
  ...
  <div className="w-full max-w-[1200px] h-[60vh]">
    <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-3 md:grid-rows-2 gap-3 h-full">
      ...
      {/* Left large image */}
      <div className="row-span-1 md:row-span-2 bg-[url('/images/plant1.png')] bg-no-repeat bg-cover bg-center rounded-3xl"></div>
      
      {/* Top right image */}
      <div className="bg-[url('/images/plant2.png')] bg-no-repeat bg-cover bg-center rounded-3xl"></div>
      
      {/* Bottom right image */}
      <div className="bg-[url('/images/plant3.png')] bg-no-repeat bg-cover bg-center rounded-3xl"></div>
  ...
  <h1 className="mx-auto text-3xl md:text-4xl text-center max-w-[800px]">
  ...
  <div className="max-w-[1200px] mx-auto px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      {teamMembers.map((member, index) => (
        <ExpertCard key={index} {...member} className="w-full" />
      ))}
    </div>
  </div>
</section>
